...
class FakeResponse:
  ...
  def __init__( self, response: Optional[bool], exception: Optional[RuntimeError] ) -> None:
    self._json = response
...
class FakeFuture:
  ...
  def __init__( self, done: bool, response: Optional[bool] = None, exception: Optional[RuntimeError] = None ) -> None:
    self._done = done
...
def MockAsyncServerResponseDone( response: bool ) -> MagicMock:
...
def MockAsyncServerResponseInProgress() -> MagicMock:
...
def MockAsyncServerResponseException( exception: RuntimeError ) -> MagicMock:
